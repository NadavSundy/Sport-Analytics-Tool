...
For the project's AI-use **process and policy**, see [AI Use](../ai/usage.md) and the course
[AI policy PDF](../ai_policy.pdf). This page indexes the underlying evidence records rather than
duplicating them.

## Central and per-member registers

Each team member records their AI usage in their own CSV under
[`evidence/ai/registers/`](https://sdp.ms.wits.ac.za/git-push-pray/Sport-Analytics-Tool/src/branch/main/evidence/ai/registers),
as described in the
...
[`ai-usage-register.csv`](https://sdp.ms.wits.ac.za/git-push-pray/Sport-Analytics-Tool/src/branch/main/evidence/ai/ai-usage-register.csv).

## Transcript evidence

Transcripts supporting register entries are stored per team member under
[`evidence/ai/transcripts/`](https://sdp.ms.wits.ac.za/git-push-pray/Sport-Analytics-Tool/src/branch/main/evidence/ai/transcripts),
