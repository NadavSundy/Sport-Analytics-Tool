...
| `embedded-postgres`               | `^16.14.0-beta.17`                           | Default disposable PostgreSQL 16 integration-test runtime.               | Runs the real database suite in the normal quality gate without Docker, administrator rights, or a hosted test database.                                              |
