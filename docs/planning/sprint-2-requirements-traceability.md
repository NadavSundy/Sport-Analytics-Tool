...
| Evidence cut-off     | 15 September 2026, `main` commit `0801df0d` plus the #364 pre-close evidence branch                                                                  |
| Close-out owner      | #298 reviews this record before Sprint 2 milestone tagging                                                                                           |
| Status               | Traceability updated through #417 formal submitter testing and #540 season-scale publication acceptance; final Sprint 2 close-out remains under #298 |
...
5. **#298 final stakeholder close-out, retrospective and milestone tag.** This remains intentionally outside #420.
