...
| `wickets[].kind`               | Wickets lost under terminal-dismissal semantics; wickets taken when `credits_bowler`             |
| `wickets[].playerOutId`        | Dismissal records                                                                                |
| `wickets[].fielders[]`         | Fielder tallies. Not yet computed.                                                               |
| `overNumber`, `positionInOver` | Delivery identity and innings-progress presentation                                              |
