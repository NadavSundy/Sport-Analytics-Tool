# Issue #599 representative-scale API measurement, run 1 of 3

Everything below the rule is the unmodified output of
`scripts/measure-api-response-times.mjs`, written by
`npm run measure:performance:local -- --output evidence/validation/issue-599/api-response-times-run-1.md`
...
This is run 1 of 3. All three runs, and their comparison against the prior local
...
| --------------------- | -------: | -------: | ----------: | ------ |
| public fixture page   |      5.0 |     10.0 |         500 | pass   |
| fixture event page    |     15.5 |     19.1 |         750 | pass   |
| fixture statistics    |      1.5 |     22.2 |        1500 | pass   |
| participant aggregate |      1.5 |    133.1 |        1500 | pass   |
| CSV event export      |     36.9 |     39.5 |        1000 | pass   |
