# Issue #599 representative-scale API measurement, run 2 of 3

Everything below the rule is the unmodified output of
`scripts/measure-api-response-times.mjs`, written by
`npm run measure:performance:local -- --output evidence/validation/issue-599/api-response-times-run-2.md`
...
This is run 2 of 3. All three runs, and their comparison against the prior local
...
| --------------------- | -------: | -------: | ----------: | ------ |
| public fixture page   |      5.2 |     12.2 |         500 | pass   |
| fixture event page    |     18.4 |     22.2 |         750 | pass   |
| fixture statistics    |      2.1 |     28.9 |        1500 | pass   |
| participant aggregate |      1.4 |    155.1 |        1500 | pass   |
| CSV event export      |     43.0 |     47.8 |        1000 | pass   |
