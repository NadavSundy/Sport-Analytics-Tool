...
| [`issue-565-production-scale-deployment-acceptance.md`](issue-565-production-scale-deployment-acceptance.md) | #565  | **Pending a live run.** Backend health with CORS and the two static frontend routes are recorded as passing on 2026-09-22; every other row, including the whole asynchronous release lifecycle and all capacity and replica signals, is `pending`. |
