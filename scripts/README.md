...
| `retrieve-user-testing-feedback.mjs` | `npm run retrieve:user-testing-feedback`                               | Retrieves restricted Power Automate feedback JSON through Microsoft Graph into `testing/user-feedback/input/`. It never logs credentials, source identifiers, filenames, or response content. |
